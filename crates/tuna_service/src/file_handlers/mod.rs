...
use tuna_analyze::{AnalysisFilter, AnalyzerDiagnostic};
use tuna_console::fmt::Formatter;
use tuna_console::markup;
use tuna_diagnostics::{Diagnostic, Severity};
use tuna_formatter::Printed;
use tuna_fs::RomePath;
use tuna_js_syntax::{TextRange, TextSize};
...
impl Language {
    ...
    ///
    /// ```
    /// # use tuna_service::workspace::Language;
...
impl tuna_console::fmt::Display for Language {
...
impl tuna_console::fmt::Display for Mime {
...
pub struct FixAllParams<'a> {
    ...
    pub(crate) tuna_path: &'a RomePath,
}
...
pub(crate) struct LintResults {
    pub(crate) diagnostics: Vec<tuna_diagnostics::serde::Diagnostic>,
...
impl Features {
    ...
    pub(crate) fn get_language(tuna_path: &RomePath) -> Language {
        tuna_path
            .extension()
    ...
    pub(crate) fn get_capabilities(
        ...
        match Self::get_language(tuna_path).or(language_hint) {
            Language::JavaScript
