...
use tuna_formatter::{IndentStyle, LineWidth};
...
impl WorkspaceSettings {
    ...
    pub fn get_severity_from_rule_code(
        &self,
        code: &Category,
    ) -> Option<tuna_diagnostics::Severity> {
...
pub trait Language: tuna_rowan::Language {
    ...
    type FormatOptions: tuna_formatter::FormatOptions;
