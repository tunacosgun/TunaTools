...
use tuna_analyze::ActionCategory;
pub use tuna_analyze::RuleCategories;
use tuna_console::{markup, Markup, MarkupBuf};
use tuna_diagnostics::CodeSuggestion;
use tuna_formatter::Printed;
use tuna_fs::RomePath;
use tuna_js_syntax::{TextRange, TextSize};
use tuna_text_edit::TextEdit;
...
pub struct PullDiagnosticsResult {
    pub diagnostics: Vec<tuna_diagnostics::serde::Diagnostic>,
    pub errors: usize,
...
pub enum FixFileMode {
    /// Applies [safe](tuna_diagnostics::Applicability::Always) fixes
    SafeFixes,
    /// Applies [safe](tuna_diagnostics::Applicability::Always) and suggested [safe](tuna_diagnostics::Applicability::MaybeIncorrect)
    SafeAndUnsafeFixes,
}
