...
impl Rules {
    #[doc = r" Checks if the code coming from [tuna_diagnostics::Diagnostic] corresponds to a rule."]
    ...
    #[doc = r" Given a category coming from [Diagnostic](tuna_diagnostics::Diagnostic), this function returns"]
    #[doc = r" the [Severity](tuna_diagnostics::Severity) associated to the rule, if the configuration changed it."]
    #[doc = r""]
    ...
    pub fn as_enabled_rules(&self) -> IndexSet<RuleFilter> {
        ...
        } else if self.is_recommended() && tuna_flags::is_unstable() {
