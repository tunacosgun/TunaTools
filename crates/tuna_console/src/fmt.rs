...
/// The [Formatter] is the `tuna_console` equivalent to [std::fmt::Formatter]:
...
/// Formatting trait for types to be displayed as markup, the `tuna_console`
