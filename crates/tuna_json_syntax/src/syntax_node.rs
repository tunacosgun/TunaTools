...
pub type JsonSyntaxNode = tuna_rowan::SyntaxNode<JsonLanguage>;
pub type JsonSyntaxToken = tuna_rowan::SyntaxToken<JsonLanguage>;
pub type JsonSyntaxElement = tuna_rowan::SyntaxElement<JsonLanguage>;
pub type JsonSyntaxNodeChildren = tuna_rowan::SyntaxNodeChildren<JsonLanguage>;
pub type JsonSyntaxElementChildren = tuna_rowan::SyntaxElementChildren<JsonLanguage>;
pub type JsonSyntaxList = tuna_rowan::SyntaxList<JsonLanguage>;
