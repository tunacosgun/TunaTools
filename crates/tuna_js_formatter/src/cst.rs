use crate::prelude::*;
use tuna_formatter::{FormatOwnedWithRule, FormatRefWithRule};

use crate::{AsFormat, IntoFormat, JsFormatContext};
use tuna_js_syntax::{map_syntax_node, JsSyntaxNode};

#[derive(Debug, Copy, Clone, Default)]
pub struct FormatJsSyntaxNode;

impl tuna_formatter::FormatRule<JsSyntaxNode> for FormatJsSyntaxNode {
