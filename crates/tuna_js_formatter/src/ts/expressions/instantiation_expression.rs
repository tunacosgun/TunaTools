...
use tuna_js_syntax::{TsInstantiationExpression, TsInstantiationExpressionFields};
...
impl NeedsParentheses for TsInstantiationExpression {
    fn needs_parentheses_with_parent(&self, parent: &tuna_js_syntax::JsSyntaxNode) -> bool {
