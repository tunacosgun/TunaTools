...
use tuna_js_syntax::{AnyJsExpression, JsSyntaxNode};
use tuna_js_syntax::{JsSyntaxKind, TsTypeAssertionExpression, TsTypeAssertionExpressionFields};
...
mod tests {
    ...
    use tuna_js_syntax::TsTypeAssertionExpression;
