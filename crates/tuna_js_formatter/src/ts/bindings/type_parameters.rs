use crate::prelude::*;
use tuna_formatter::FormatError::SyntaxError;
use tuna_formatter::{format_args, write, FormatRuleWithOptions, GroupId};
use tuna_js_syntax::{TsTypeParameters, TsTypeParametersFields};
