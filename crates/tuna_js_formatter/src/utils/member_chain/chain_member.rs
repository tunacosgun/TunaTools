...
pub(crate) enum ChainMember {
    /// Holds onto a [tuna_js_syntax::JsStaticMemberExpression]
    StaticMember {
        expression: JsStaticMemberExpression,
    },

    /// Holds onto a [tuna_js_syntax::JsCallExpression]
    CallExpression {
        expression: JsCallExpression,
        position: CallExpressionPosition,
    },

    /// Holds onto a [tuna_js_syntax::JsComputedMemberExpression]
    ComputedMember {
    ...
    /// Any other node that are not  [tuna_js_syntax::JsCallExpression] or [tuna_js_syntax::JsStaticMemberExpression]
    /// Are tracked using this variant
    Node(JsSyntaxNode),
}

impl ChainMember {
    /// checks if the current node is a [tuna_js_syntax::JsCallExpression], or a [tuna_js_syntax::JsImportExpression]
