...
//! ```
//!
//! When we track the first [tuna_js_syntax::JsCallExpression], we hold basically all the children,
...
//!
//! 1. as many as [tuna_js_syntax::JsCallExpression] we can find, this cover cases like
//! `something()()().then()`;
//! 2. as many as [tuna_js_syntax::JsComputedMemberExpression] we can find, this cover cases like
//! `something()()[1][3].then()`;
//! 3. as many as consecutive [tuna_js_syntax::JsStaticMemberExpression] or [tuna_js_syntax::JsComputedMemberExpression], this cover cases like
//! `this.items[0].then()`
//!
...
use crate::JsLabels;
use tuna_formatter::{write, Buffer};
use tuna_js_syntax::{
...
use tuna_rowan::{AstNode, SyntaxResult};
