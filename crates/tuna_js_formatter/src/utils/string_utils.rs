...
use crate::prelude::*;
use tuna_formatter::token::string::normalize_string;
use tuna_js_syntax::JsSyntaxKind::{JSX_STRING_LITERAL, JS_STRING_LITERAL};
use tuna_js_syntax::{JsFileSource, JsSyntaxToken};
use std::borrow::Cow;
...
/// Convenience enum to map [tuna_js_syntax::JsFileSource] by just reading
/// the type of file
#[derive(Eq, PartialEq)]
...
mod tests {
    ...
    use tuna_formatter::token::string::ToAsciiLowercaseCow;
    use tuna_js_factory::JsSyntaxTreeBuilder;
    use tuna_js_syntax::JsSyntaxKind::{JS_STRING_LITERAL, JS_STRING_LITERAL_EXPRESSION};
    use tuna_js_syntax::{JsStringLiteralExpression, JsSyntaxToken};
