...
use tuna_js_syntax::{JsForOfStatement, JsIdentifierAssignmentFields};
use tuna_js_syntax::{JsIdentifierAssignment, JsSyntaxNode};
...
mod tests {
    ...
    use tuna_js_syntax::JsIdentifierAssignment;
