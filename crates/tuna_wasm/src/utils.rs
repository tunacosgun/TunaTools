...
use tuna_console::fmt::HTML;
use tuna_console::{fmt::Formatter, markup};
use tuna_diagnostics::serde::Diagnostic;
use tuna_diagnostics::{DiagnosticExt, LineIndexBuf, PrintDiagnostic, SourceCode};
...
impl DiagnosticPrinter {
    ...
    fn print(
        ...
        printer: fn(&tuna_diagnostics::Error) -> PrintDiagnostic<tuna_diagnostics::Error>,
    ) -> Result<(), Error> {
        let diag: Diagnostic =
