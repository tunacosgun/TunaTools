...
use crate::Parser;
use tuna_diagnostics::console::fmt::Display;
use tuna_diagnostics::console::{markup, MarkupBuf};
use tuna_diagnostics::location::AsSpan;
use tuna_diagnostics::{Advices, Diagnostic, Location, LogCategory, MessageAndDescription, Visit};
use tuna_rowan::{SyntaxKind, TextLen, TextRange};
...
impl ParseDiagnostic {
    ...
    /// # use tuna_diagnostics::{DiagnosticExt, PrintDiagnostic, console::fmt::Formatter};
    /// # use tuna_parser::diagnostic::ParseDiagnostic;
    /// # use tuna_rowan::{TextSize, TextRange};
    /// # use std::fmt::Write;
    ///
    /// let source = "const a";
    ...
    ///
    /// let mut write = tuna_diagnostics::termcolor::Buffer::no_color();
