...
///
/// ```rust
/// use tuna_formatter::{SimpleFormatContext, format, format_args};
...
/// ```rust
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::{Buffer, FormatState, SimpleFormatContext, VecBuffer, write};
///
/// # fn main() -> FormatResult<()> {
...
/// ```rust
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::{FormatState, VecBuffer};
///
/// # fn main() -> FormatResult<()> {
/// let mut state = FormatState::new(SimpleFormatContext::default());
/// let mut buffer = VecBuffer::new(&mut state);
...
///
/// ```
/// use tuna_formatter::{Formatted, LineWidth, format, format_args, SimpleFormatOptions};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
