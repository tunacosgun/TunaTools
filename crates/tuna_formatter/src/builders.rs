...
use tuna_rowan::{Language, SyntaxNode, SyntaxToken, TextLen, TokenText};
use std::borrow::Cow;
use std::cell::Cell;
...
///
/// ```
/// use tuna_formatter::{format, format_args};
...
/// ```
/// use tuna_formatter::{format, format_args, LineWidth, SimpleFormatOptions};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
...
/// ```
/// use tuna_formatter::{format_args, format, LineWidth, SimpleFormatOptions};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
/// ```rust
/// # use tuna_formatter::prelude::*;
/// # use tuna_formatter::{format, write, LineWidth};
///
...
/// ```
/// use std::num::NonZeroU8;
/// use tuna_formatter::{format, format_args, IndentStyle, SimpleFormatOptions};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
///
/// ```
/// use tuna_formatter::{format, format_args, LineWidth};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let elements = format!(SimpleFormatContext::default(), [
...
/// use tuna_formatter::{format_args, format, LineWidth, SimpleFormatOptions};
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::printer::PrintWidth;
///
/// fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
///     line_width: LineWidth::try_from(20).unwrap(),
...
impl<Context> IfGroupBreaks<'_, Context> {
    ...
    ///
    /// ```
    /// use tuna_formatter::{format, format_args, write, LineWidth, SimpleFormatOptions};
    /// use tuna_formatter::prelude::*;
    ///
    /// # fn main() -> FormatResult<()> {
    /// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
/// ```
/// use tuna_formatter::{format, format_args, LineWidth, SimpleFormatOptions, write};
/// use tuna_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
...
/// ```
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::{SimpleFormatContext, format, write};
/// use tuna_rowan::TextSize;
///
/// struct MyFormat {
...
/// ```
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::{SimpleFormatContext, format, write, Buffer};
///
/// struct MyFormat;
///
