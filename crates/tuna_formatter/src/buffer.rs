...
pub trait Buffer {
    ...
    ///
    /// ```
    /// use tuna_formatter::{Buffer, FormatElement, FormatState, SimpleFormatContext, VecBuffer};
    ///
    ...
    /// use tuna_formatter::{Buffer, FormatState, SimpleFormatContext, VecBuffer, format_args};
    ///
    /// let mut state = FormatState::new(SimpleFormatContext::default());
    /// let mut buffer = VecBuffer::new(&mut state);
    ///
...
///
/// ```
/// use tuna_formatter::{FormatState, Formatted, PreambleBuffer, SimpleFormatContext, VecBuffer, write};
/// use tuna_formatter::prelude::*;
///
/// struct Preamble;
///
...
/// ```
/// use tuna_formatter::prelude::*;
/// use tuna_formatter::{format, write};
///
/// # fn main() -> FormatResult<()> {
/// use tuna_formatter::{RemoveSoftLinesBuffer, SimpleFormatContext, VecBuffer};
/// use tuna_formatter::prelude::format_with;
...
pub trait BufferExtensions: Buffer + Sized {
    ...
    /// use std::ops::Deref;
    /// use tuna_formatter::prelude::*;
    /// use tuna_formatter::{write, format, SimpleFormatContext};
    ///
    /// # fn main() -> FormatResult<()> {
