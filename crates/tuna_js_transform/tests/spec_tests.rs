use tuna_analyze::{AnalysisFilter, AnalyzerTransformation, ControlFlow, Never, RuleFilter};
use tuna_js_formatter::context::JsFormatOptions;
use tuna_js_formatter::format_node;
...
pub(crate) fn analyze_and_snap(
    ...
    let (_, errors) = tuna_js_transform::transform(&root, filter, &options, source_type, |event| {
