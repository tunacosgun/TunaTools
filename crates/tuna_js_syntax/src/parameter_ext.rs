...
/// use tuna_js_syntax::{AnyJsBinding, AnyJsBindingPattern, AnyJsConstructorParameter, AnyJsFormalParameter, AnyJsParameter};
/// use tuna_js_syntax::parameter_ext::AnyJsParameterList;
///
...
impl AnyJsParameterList {
    ...
    /// ```
    /// use tuna_js_factory::make;
    /// use tuna_js_syntax::parameter_ext::{AnyJsParameterList, AnyParameter};
    /// use tuna_js_syntax::{
    ///     AnyJsBinding, AnyJsBindingPattern, AnyJsConstructorParameter, AnyJsFormalParameter,
    ///     AnyJsParameter, T,
    /// };
    /// use tuna_rowan::SyntaxResult;
    ///
    /// let parameter_list = make::js_parameter_list(
    ///     Some(AnyJsParameter::AnyJsFormalParameter(
    ///         AnyJsFormalParameter::JsFormalParameter(
