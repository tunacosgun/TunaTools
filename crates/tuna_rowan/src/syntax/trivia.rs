...
use tuna_text_size::{TextRange, TextSize};
use std::fmt;
...
impl<L: Language> SyntaxTriviaPiece<L> {
    ...
    ///
    /// ```
    /// use tuna_rowan::raw_language::{RawLanguage, RawLanguageKind, RawSyntaxTreeBuilder};
    /// use tuna_rowan::*;
...
///
/// ```
/// use tuna_rowan::raw_language::{RawLanguage, RawLanguageKind};
/// use tuna_rowan::{trim_leading_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece};
///
...
/// ```
/// use tuna_rowan::raw_language::{RawLanguage, RawLanguageKind};
/// use tuna_rowan::{trim_trailing_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece};
///
/// let token = SyntaxToken::<RawLanguage>::new_detached(
///     RawLanguageKind::LET_TOKEN,
///     "\t/*c*/\n\t let ",
...
/// ```
/// use tuna_rowan::raw_language::{RawLanguage, RawLanguageKind, RawSyntaxTreeBuilder};
/// use tuna_rowan::{chain_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece, TriviaPieceKind};
///
