...
use tuna_diagnostics::panic::PanicError;
use tuna_fs::CONFIG_NAME;
use tuna_service::workspace::{RageEntry, RageParams, RageResult};
use tuna_service::{workspace, Workspace};
use serde_json::json;
...
impl LSPServer {
    ...
    async fn rage(&self, params: RageParams) -> LspResult<RageResult> {
        let mut entries = vec![
            ...
            RageEntry::pair("Version", tuna_service::VERSION),
    ...
    async fn setup_capabilities(&self) {
        ...
        capabilities.add_capability(
            "tuna_did_change_extension_settings",
        ...
        capabilities.add_capability(
            "tuna_did_change_workspace_settings",
...
impl LanguageServer for LSPServer {
    ...
    async fn initialize(&self, params: InitializeParams) -> LspResult<InitializeResult> {
        ...
        let init = InitializeResult {
            ...
            server_info: Some(ServerInfo {
                ...
                version: Some(tuna_service::VERSION.to_string()),
            }),
        };
    ...
    async fn code_action(&self, params: CodeActionParams) -> LspResult<Option<CodeActionResponse>> {
        tuna_diagnostics::panic::catch_unwind(move || {
    ...
    async fn formatting(
        ...
        let result = tuna_diagnostics::panic::catch_unwind(move || {
