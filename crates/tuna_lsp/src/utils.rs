...
use tuna_console::fmt::{self, Formatter};
use tuna_console::MarkupBuf;
...
use tuna_service::workspace::CodeAction;
use tuna_text_edit::{CompressedOp, DiffOp, TextEdit};
use std::any::Any;
...
/// Convert an [tuna_diagnostics::Diagnostic] to a [lsp::Diagnostic], using the span
