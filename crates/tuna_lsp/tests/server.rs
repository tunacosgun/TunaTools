...
use tuna_lsp::LSPServer;
use tuna_lsp::ServerFactory;
use tuna_lsp::WorkspaceSettings;
use tuna_service::workspace::GetSyntaxTreeResult;
use tuna_service::workspace::{GetFileContentParams, GetSyntaxTreeParams};
...
impl Server {
    ...
    async fn tuna_shutdown(&mut self) -> Result<()> {
