...
use tuna_service::{workspace::WorkspaceClient, TransportError, WorkspaceError};
...
fn setup_tracing_subscriber() {
    let file_appender = tracing_appender::rolling::hourly(tuna_log_dir(), log_file_name_prefix());
...
pub(super) fn tuna_log_dir() -> PathBuf {
