...
use tuna_console::{ColorMode, Console};
use tuna_fs::OsFileSystem;
use tuna_service::{App, DynRef, Workspace, WorkspaceRef};
use std::env;
...
pub use crate::commands::{tuna_command, RomeCommand};
    ...
    pub fn run(self, command: RomeCommand) -> Result<(), CliDiagnostic> {
        ...
        let result = match command {
            ...
            RomeCommand::Check {
                ...
                apply_unsafe,
                cli_options,
                configuration: tuna_configuration,
                paths,
                stdin_file_path,
                linter_enabled,
