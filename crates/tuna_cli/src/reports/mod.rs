...
use tuna_service::WorkspaceError;
use serde::Serialize;
...
/// Information computed from a [diagnostic][tuna_diagnostics::Diagnostic]
#[derive(Debug, Serialize)]
pub struct ReportDiagnostic {
    /// Severity of the [diagnostic][tuna_diagnostics::Diagnostic]
    pub severity: Severity,
    /// The code of the [diagnostic][tuna_diagnostics::Diagnostic]
    pub code: Option<&'static Category>,
    /// The title of the [diagnostic][tuna_diagnostics::Diagnostic]
    pub title: String,
}
