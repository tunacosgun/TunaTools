use tuna_js_syntax::{AnyJsExpression, JsSyntaxKind};
...
mod tests {
    ...
    use tuna_js_syntax::{JsFileSource, JsIdentifierBinding, JsVariableDeclarator};
    ...
    fn assert_is_const(code: &str, is_const: bool) {
        ...
        let r = tuna_js_parser::parse(code, JsFileSource::js_module(), JsParserOptions::default());
