...
pub use tuna_console as console;

// Re-export macros from utility crates
pub use tuna_diagnostics_categories::{category, category_concat, Category};
pub use tuna_diagnostics_macros::Diagnostic;
...
pub mod prelude {
    ...
    //! intended to be imported as `use tuna_diagnostics::prelude::*;` to
