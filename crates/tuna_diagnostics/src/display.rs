...
use tuna_console::{fmt, markup, HorizontalLine, Markup, MarkupBuf, MarkupElement, MarkupNode};
...
/// implementing [tuna_console::fmt::Write].
...
mod tests {
    ...
    use tuna_console::{fmt, markup};
    use tuna_diagnostics::{DiagnosticTags, Severity};
    use tuna_diagnostics_categories::{category, Category};
    use tuna_text_edit::TextEdit;
    use tuna_text_size::{TextRange, TextSize};
    use serde_json::{from_value, json};

    use crate::{self as tuna_diagnostics};
    use crate::{
