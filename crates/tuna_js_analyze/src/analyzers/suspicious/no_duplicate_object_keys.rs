...
use tuna_analyze::{declare_rule, Ast, Rule, RuleDiagnostic};
...
use tuna_rowan::{AstNode, BatchMutationExt, TokenText};
...
impl Rule for NoDuplicateObjectKeys {
    ...
    fn action(
        ...
        Some(JsRuleAction {
            category: tuna_analyze::ActionCategory::QuickFix,
            // The property initialization could contain side effects
            applicability: tuna_diagnostics::Applicability::MaybeIncorrect,
