use tuna_analyze::{context::RuleContext, declare_rule, Ast, Rule, RuleDiagnostic};
use tuna_console::markup;
use tuna_js_syntax::{AnyJsExpression, AnyJsFunction, JsNewExpression, JsNewExpressionFields};
