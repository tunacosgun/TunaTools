...
use tuna_analyze::{context::RuleContext, declare_rule, ActionCategory, Rule, RuleDiagnostic};
use tuna_console::markup;
use tuna_diagnostics::Applicability;
use tuna_js_factory::make;
use tuna_js_syntax::{global_identifier, AnyJsExpression, JsCallExpression, JsNewExpression};
use tuna_rowan::{chain_trivia_pieces, AstNode, BatchMutationExt};
