...
use tuna_parser::event::Event;
use tuna_parser::token_source::Trivia;
use tuna_rowan::{AstNode, NodeCache};
...
impl<T> Parse<T> {
    ...
    ///
    /// ```
    /// use tuna_js_parser::{JsParserOptions, parse_script};
    /// use tuna_js_syntax::{JsIfStatement, JsSyntaxKind};
    /// use tuna_rowan::{AstNode, AstNodeList};
    ///
...
/// ```
/// use tuna_js_parser::{JsParserOptions, parse_script};
/// use tuna_js_syntax::{JsSyntaxToken, JsFileSource, JsSyntaxList, JsComputedMemberExpression};
/// use tuna_rowan::{AstNode, Direction};
///
...
/// ```
/// use tuna_js_parser::{JsParserOptions, parse_module};
/// let source = r#"
...
/// ```
/// use tuna_js_parser::{JsParserOptions, parse_module};
/// use tuna_js_syntax::JsSyntaxKind;
...
///
/// ```
/// use tuna_js_parser::{JsParserOptions, parse};
/// use tuna_js_syntax::{LanguageVariant, LanguageVersion, ModuleKind, JsFileSource};
...
///
/// ```
/// use tuna_js_parser::{JsParserOptions, parse_js_with_cache};
...
pub fn parse_js_with_cache(
    ...
    tracing::debug_span!("parse").in_scope(move || {
        ...
        tuna_parser::event::process(&mut tree_sink, events, errors);
